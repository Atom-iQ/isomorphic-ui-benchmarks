var createRvdElement = require("@atom-iq/core").createRvdElement;
                  ...
                  <tr>
                    ...
                    <td>
                      <ul>
                        ...
                        <li class="gf-li" style={{ paddingTop: 8 }}>
                      ...
                      <ul>
                        ...
                        <li class="gf-li">
                          <a
                            ...
                            class="thrd gf-i"
                          >
                            <i class="gspr icfbg">Facebook</i>
                          </a>
                          <i class="gspr icfbg"></i>
                        </li>
                        <i class="gspr icfbg">
                          <li class="gf-li">
                            <a
                              ...
                              class="thrd gf-i"
                            >
                              <i class="gspr ictwg">Twitter</i>
                            </a>
                            <i class="gspr ictwg"></i>
                          </li>
                          <i class="gspr ictwg">
                            <li class="gf-li">
                              <a
                                ...
                                class="thrd gf-i"
                              >
                                <i class="gspr icgpg">Google+</i>
                              </a>
                              <i class="gspr icgpg"></i>
                            </li>
                            <i class="gspr icgpg"></i>
                          </i>
                        </i>
                        ...
                        <li class="gf-li">
                          <div class="gf-flags-wpr">
                            ...
                            >
                              ...
                              <b id="gf-fbtn-arr" class="gh-sprRetina" />
                            </a>
